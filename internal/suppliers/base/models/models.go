...
type CancelRequestParams struct {
	...
	// Configuration Supplier specific parameters for all post-type requests except booking. Override in supplier module for all post-routes except booking
	Configuration HertzConfiguration `json:"configuration"`
...
// CancelHertzBookingJSONRequestBody defines body for CancelHertzBooking for application/json ContentType.
type CancelHertzBookingJSONRequestBody = CancelRequestParams
